...
public class RequestHandler {
    ...
    public String sendUpdateRequest(String requestURL, HashMap<String, String> updateDataParams, String id) {
        ...
        try {
            ...
            writer.write(getPostDataString(updateDataParams));
            writer.flush();
            writer.close();
            os.close();
    ...
    public String sendDeleteRequest(String requestURL, HashMap<String, String> updateDataParams, String id) {
        StringBuilder sb = new StringBuilder();
